    ...
    <main className="pt-32 pb-24 bg-university-paper">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div
          ...
          className="mb-20"
        >
          <div className="inline-block px-3 py-1 border border-university-navy/20 text-university-navy/40 text-[10px] font-bold uppercase tracking-[0.3em] mb-6">
        ...
        <section className="mb-32">
          <div className="bg-white p-8 md:p-16 border border-university-navy/10 shadow-sm relative overflow-hidden">
            <div className="absolute top-0 right-0 p-8 text-[10px] font-mono text-university-navy/20 uppercase tracking-widest hidden md:block">
            ...
            <div className="relative z-10 grid lg:grid-cols-3 gap-16 items-center">
              <div className="lg:col-span-1 space-y-8">
                <h2 className="font-serif text-4xl text-university-navy flex items-center gap-3">
                  <Map className="h-6 w-6 text-university-gold" />
                ...
                <div className="space-y-4">
                  <TopologyLabel color="bg-university-crimson" label="Admin Core" status="SECURE" />
                  <TopologyLabel color="bg-university-gold" label="Inference Shards" status="ACTIVE" />
                  <TopologyLabel color="bg-university-navy" label="Sandbox Arena" status="ISOLATED" />
                </div>
              </div>

              <div className="lg:col-span-2">
                <div className="aspect-[16/9] bg-university-paper/50 border border-university-navy/5 relative flex items-center justify-center group">
                  {/* Stylized SVG Map */}
                  <svg viewBox="0 0 400 200" className="w-full h-full p-12 transition-transform duration-700 group-hover:scale-105">
                    ...
                    <line x1="200" y1="100" x2="300" y2="50" className="stroke-university-navy/20 stroke-1" strokeDasharray="4 2" />
                    <line x1="200" y1="100" x2="100" y2="50" className="stroke-university-navy/20 stroke-1" strokeDasharray="4 2" />
                    <line x1="200" y1="100" x2="200" y2="170" className="stroke-university-navy/20 stroke-1" strokeDasharray="4 2" />
                    
                    <rect x="290" y="40" width="20" height="20" className="fill-university-gold/40" />
                    <rect x="90" y="40" width="20" height="20" className="fill-university-gold/40" />
                    <polygon points="190,170 210,170 200,190" className="fill-university-navy/40" />
                    
                    <text x="215" y="105" className="text-[8px] fill-university-navy font-bold uppercase tracking-widest">Mainframe</text>
                    <text x="70" y="30" className="text-[6px] fill-university-navy/40 font-bold uppercase tracking-widest">Dormitory A</text>
                    <text x="280" y="30" className="text-[6px] fill-university-navy/40 font-bold uppercase tracking-widest">Dormitory B</text>
                    <text x="180" y="160" className="text-[6px] fill-university-navy/40 font-bold uppercase tracking-widest">Sandbox</text>
                  </svg>
                </div>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-24 mb-32 items-center">
           <div className="relative">
             <img src="https://picsum.photos/seed/datacenter_arch/1200/1200" alt="VNU Mainframe Arch" className="w-full aspect-square object-cover filter grayscale border-r-8 border-b-8 border-university-gold" referrerPolicy="no-referrer" />
        ...
        <section className="bg-university-navy text-university-paper p-12 md:p-20 relative overflow-hidden">
...
function TopologyLabel({ color, label, status }: { color: string, label: string, status: string }) {
  return (
    <div className="flex items-center justify-between p-3 bg-university-paper border border-university-navy/5">
      <div className="flex items-center gap-3">
        <div className={`w-2 h-2 rounded-full ${color}`} />
        <span className="text-xs font-bold uppercase tracking-widest text-university-navy/70">{label}</span>
      </div>
      <span className="text-[8px] font-mono font-bold bg-university-navy/5 px-2 py-0.5 rounded text-university-navy/40 tracking-widest">{status}</span>
    </div>
  )
}
  ...
  return (
    <div className="flex flex-col items-center gap-4 text-center group">
      ...
      <div>
        ...
        <div className="text-[10px] uppercase tracking-[0.25em] font-bold text-white/30">{label}</div>
      </div>
    </div>
  )
}
