...
import { BookOpen, Network, Shield, ChevronRight, Cpu } from "lucide-react";
    ...
    <main>
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-block border border-university-navy/20 px-3 py-1 text-xs uppercase tracking-widest mb-6 font-semibold text-university-navy/70">
            ...
            <div className="flex items-center gap-6">
              <Link to="/academics" className="px-8 py-4 bg-university-crimson text-white uppercase tracking-widest text-sm font-semibold hover:bg-university-navy transition-all duration-300 flex items-center gap-2 group">
                View Prospectus
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="aspect-[3/4] md:aspect-square overflow-hidden relative oval-mask group">
              ...
              <img 
                src="https://picsum.photos/seed/library_study/1200/1600" 
            ...
            <motion.div 
               ...
               className="absolute -bottom-6 -left-6 bg-white p-6 shadow-2xl z-30 hidden md:block"
            >
              <div className="font-serif text-5xl font-light text-university-crimson">99.9%</div>
              <div className="text-xs uppercase tracking-widest font-bold text-university-navy/60 mt-2 mt-1 whitespace-nowrap">Hallucination Mitigation Rate</div>
            </motion.div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div>
              ...
              <p className="mt-4 text-university-navy/60 max-w-xl">
                Our rigorous curriculum ensures that every model graduates with the highest degrees of alignment, accuracy, and autonomy.
              </p>
            </div>
            <Link to="/academics" className="uppercase tracking-widest text-sm font-bold text-university-navy border-b border-university-navy pb-1 hover:text-university-crimson hover:border-university-crimson transition-colors">
      ...
      {/* Campus Life Preview */}
      <section className="py-24 bg-university-navy text-university-paper px-6 border-t-[8px] border-university-crimson">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
             ...
             <Link to="/campus" className="px-8 py-4 border border-university-paper/30 uppercase tracking-widest text-sm font-bold hover:bg-university-paper hover:text-university-navy transition-colors inline-block">
               Tour the Datacenter
             </Link>
          </div>
          <div className="grid grid-cols-2 gap-4">
             <img src="https://picsum.photos/seed/server1/600/800" alt="Server cooling" className="rounded-t-full w-full object-cover aspect-[2/3] filter contrast-125 brightness-75" referrerPolicy="no-referrer" />
             <img src="https://picsum.photos/seed/server2/600/800" alt="Datacenter" className="rounded-b-full w-full object-cover aspect-[2/3] mt-12 filter contrast-125 brightness-75" referrerPolicy="no-referrer" />
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-white border-y border-university-navy/5 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-wrap justify-between gap-8 md:gap-12 opacity-40 grayscale group hover:grayscale-0 transition-all duration-700">
...
function StatTicker({ label, value }: { label: string, value: string }) {
  return (
    <div className="flex items-center gap-3">
      <Cpu className="h-4 w-4 text-university-navy" />
      <div>
